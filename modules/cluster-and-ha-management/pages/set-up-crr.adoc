...
* Install TigerGraph 4.0 or higher on both the primary cluster and the DR cluster *in the same version*.
...
3. Start CRR on the DR cluster(From TigerGraph 4.0, no additional restart is required to start CRR).
